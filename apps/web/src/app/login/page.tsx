    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/40 px-4 py-12">
      <Card className="w-full max-w-md shadow-sm">
        <CardHeader>
          ...
          <CardDescription>Sign in to your Orion account</CardDescription>
        </CardHeader>
        <CardContent>
          {state.error && (
          ...
          {state.success && (
            <div className="bg-green-100 text-green-800 text-sm rounded-lg px-4 py-3 mb-4">
              {state.success}
            </div>
          )}
          ...
          <div className="space-y-2">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full h-10 rounded-md px-8 border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground text-sm font-medium transition-colors"
            >
